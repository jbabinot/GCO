...
$sql_devis_four = "DELETE FROM devis_four WHERE iddevisfour =".$iddevisfour;
  ...
  <div class="page-content"> 
    ...
    <div class="content">  
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active"><span class="semi-bold">Supprimer Devis</span></a></li>
      </ul>
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>ACHAT - <span class="semi-bold">Supprimer Devis</span></h3>
      </div>
      <?php
            ...
            <div class="grid-body no-border">
              <div class="row-fluid">
                <div class="alert alert-block alert-success fade in">
                  ...
                  <p> Le devis  N°DEVFOUR000<?php echo $iddevisfour; ?> &agrave; &eacute;t&eacute; supprim&eacute; avec succ&egrave;s. </p>
                </div>
              </div>
            </div>
          </div>
