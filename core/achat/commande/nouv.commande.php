  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="index.php">Commande</a></li>
        ...
        <div class="col-md-12">
          <div class="grid simple transparent">
            <div class="grid-title">
              <h4>Nouvelle <span class="semi-bold">Commande</span></h4>
              <div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#grid-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
            </div>
            <div class="grid-body ">
              <div class="row">
                <form id="commentForm" action="valid.nouv.commande.php" method="post">
                        ...
                        <div class="row form-row">
                          <div class="col-md-6">
                            <div class="input-append success date col-md-10 col-lg-6 no-padding">
                              ...
                              <input type="text" class="form-control" name="date_cmd_four" Value="<?php echo $date; ?>">
                          ...
                          <div class="col-md-6">
                            <div class="input-append success date col-md-10 col-lg-6 no-padding">
                              <label>Date de livraison théorique</label>
                              <input type="text" class="form-control" name="date_livraison_cmd_four" Value="<?php echo $date_30; ?>">
                              <span class="add-on"><span class="arrow"></span><i class="fa fa-th"></i></span> </div>
                            <br>
                            <br>
                            <div class="clearfix"></div>
