...
$date_cmd_four = $_POST['date_devis_four'];
$date_livraison_cmd_four = $_POST['date_livraison_cmd_four'];
...
$ptht_cmd_four = ($pvht1*$qte1)+($pvht2*$qte2)+($pvht3*$qte3)+($pvht4*$qte4)+($pvht5*$qte5)+($pvht6*$qte6)+($pvht7*$qte7)+($pvht8*$qte8)+($pvht9*$qte9)+($pvht10*$qte10)+($pvht11*$qte11)+($pvht12*$qte12)+$port+$eco_part-$remise;
$tva = $ptht_cmd_four*20/100;
$ptttc_cmd_four = $ptht_cmd_four+$tva;
...
VALUES ('','$idfournisseur','$date_cmd_four','1','$date_livraison_cmd_four','$idarticle1','$qte1','$idarticle2','$qte2','$idarticle3','$qte3','$idarticle4','$qte4','$idarticle5','$qte5','$idarticle6','$qte6','$idarticle7','$qte7',
  ...
  '$pvht12','$port','$remise','$eco_part','$ptht_cmd_four','$tva','$ptttc_cmd_four')";
  ...
  <div class="page-content"> 
    ...
    <div class="content">  
      <ul class="breadcrumb">
        ...
        <li><a href="index.commande.php">COMMANDE</a></li>
        <li><a href="nouv.commande.php" class="active"><span class="semi-bold">Nouvelle Commande</span></a></li>
      </ul>
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>ACHAT - <span class="semi-bold">Nouvelle Commande</span></h3>
      </div>
      <?php
            ...
            <div class="grid-body no-border">
              <div class="row-fluid">
                <div class="alert alert-block alert-success fade in">
                  ...
                  <p> La Commande en date du  <b><?php echo $date_cmd_four; ?></b> &agrave; &eacute;t&eacute; cr&eacute;er avec succ&egrave;s. </p>
                </div>
              </div>
            </div>
          </div>
