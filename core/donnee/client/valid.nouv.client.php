...
$sql_client = "INSERT INTO `gestion`.`client` (`idclient`, `iduser`, `raison_social`, `num_siret`, `num_tva`, `civilite`, `nom`, `prenom`, `adresse1`, `adresse2`, `cp`, `ville`, `tel`, `fax`, `port`, `mail`, `mode_paiement_default`, `code_banque`, `code_guichet`, `code_cpt`, `cle_rib`, `iban`, `bic`, `mail_paypal`)
VALUES ('',\"$iduser\",\"$raison_social\",\"$num_siret\",\"$num_tva\",\"$civilite\",\"$nom\",\"$prenom\",\"$adresse1\",\"$adresse2\",\"$cp\",\"$ville\",\"$tel\",\"$fax\",\"$port\",\"$mail\",\"$mode_paiement_default\",\"$code_banque\",\"$code_guichet\",\"$code_cpt\",\"$cle_rib\",\"$iban\",\"$bic\",\"$mail_paypal\")";
            ...
            <div class="grid-body no-border">
              <div class="row-fluid">
                <div class="alert alert-block alert-success fade in">
                  ...
                  <p> Le client <b><?php echo $nom; ?> <?php echo $prenom; ?></b> &agrave; &eacute;t&eacute; cr&eacute;&eacute; avec succ&egrave;s. </p>
                </div>
              </div>
            </div>
          </div>
